...
export default function AnimatedTextSlider({ 
  ...
  return (
    <section ref={containerRef} className="relative w-full py-8 overflow-hidden">
      <div className="relative w-full h-auto">
        <div ref={slider} className="flex whitespace-nowrap will-change-transform">
          <p ref={firstText} className="text-display text-(--typography-color-secondary-850) whitespace-nowrap m-0 leading-none pr-16 shrink-0">
            {text}
          </p>
          <p ref={secondText} className="text-display text-(--typography-color-secondary-850) whitespace-nowrap m-0 leading-none pr-16 shrink-0">
            {text}
          </p>
        </div>
      </div>
