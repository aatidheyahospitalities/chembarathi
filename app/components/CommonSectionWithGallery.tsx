...
export default async function commonSection({commonSectionData}: {commonSectionData: ContentSectionWithGalleryType}) {
...
const image = commonSectionData?.multipleimgCollection?.items || [];
  ...
  return (
    <div className={`section-wrapper gap-(--spacing-padding-16x) flex flex-col `} >
