    ...
    >
      ...
      >
        ...
        >
          ...
          <h2 className="text-heading-2 text-(--typography-color-secondary-100) xs:!text-h4">
            {title}
          </h2>
        </div>
        <div
      ...
      <div className="grid grid-cols-12 grid-rows-2 gap-(--spacing-padding-4x) w-full h-150 xs:h-auto xs:!grid-cols-3 xs:!grid-rows-1">
        {image.slice(0, 6).map((img, index) => {
          ...
          const spanClasses = [
            'xs:!col-span-3 3xl:col-span-3 3xl:col-span-3', // Image 1: narrow
            'xs:!col-span-3 3xl:col-span-5 3xl:col-span-5', // Image 2: widest
            'xs:!col-span-3 3xl:col-span-4 3xl:col-span-4', // Image 3: wider
            'xs:!col-span-5 3xl:col-span-5 3xl:col-span-5', // Image 4: widest
            'xs:!col-span-3 3xl:col-span-3 3xl:col-span-3', // Image 5: narrow
            'xs:!col-span-4 3xl:col-span-4 3xl:col-span-4', // Image 6: wider
          ];
